...
import { BecomeMentorScreen, NotificationScreen, OurMentors } from "../screens";
...
const Profile = ({ navigation, route }) => {
  ...
  const getMentorProfile = async () => {
    response = await fetch(baseUrl + "/mentors_profile/" + userIdStr, {
      method: "GET",
    });
  ...
  return (
    <Drawer.Navigator
      ...
      drawerContentOptions={{
        activeBackgroundColor: "#058D8Baa",
    ...
    >
      ...
      />
      <Drawer.Screen name="Become a mentor" component={BecomeMentorScreen} />
      <Drawer.Screen
        name="Our Mentors"
